...
sendMessage($chatId, "<b>BLAZE CHK ⚡️ - Status - $sat%0A━━━━━━━━━━━━━%0A[ϟ] GATE: SK KEY CHK%0A[ϟ] SK KEY: <code>$sec</code>%0A[ϟ] STATUS: DEAD KEY❌%0A[ϟ] RESPONSE: <code>$msg</code>%0A━━━━━━━━━━━━━%0A[ϟ] TIME TAKEN: $execution_time's%0A[ϟ] Checked By: @$username%0A[ϟ] UserID: $userId%0A[ϟ] Premium Activated: $stat%0A</b>%0A", $message_id);
...
sendMessage($chatId, "<b>BLAZE CHK ⚡️ - Status - $sat%0A━━━━━━━━━━━━━%0A[ϟ] GATE: SK KEY CHK%0A[ϟ] SK KEY: <code>$sec</code>%0A[ϟ] STATUS: MISSING KEY❌%0A[ϟ] RESPONSE: <code>$msg</code>%0A━━━━━━━━━━━━━%0A[ϟ] TIME TAKEN: $execution_time's%0A[ϟ] Checked By: @$username%0A[ϟ] UserID: $userId%0A[ϟ] Premium Activated: $stat%0A</b>%0A", $message_id);
}
...
sendMessage($chatId, "<b>BLAZE CHK ⚡️ - Status - $sat%0A━━━━━━━━━━━━━%0A[ϟ] GATE: SK KEY CHK%0A[ϟ] SK KEY: <code>$sec</code>%0A[ϟ] STATUS: DEAD KEY❌%0A[ϟ] RESPONSE: <code>$msg</code>%0A━━━━━━━━━━━━━%0A[ϟ] TIME TAKEN: $execution_time's%0A[ϟ] Checked By: @$username%0A[ϟ] UserID: $userId%0A[ϟ] Premium Activated: $stat%0A</b>", $message_id);
}else{
